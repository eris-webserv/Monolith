...
uplink-security-inspector-desc = Standard issue revolver. Cheaply mass produced and found in all corners of the known universe. Uses .357 magnum.
...
uplink-security-pulsepistol-desc = A high powered laser pistol normally reserved as a sidearm for TSFMC and TSFN officers. Has an internal low emission charging cell, for some degree of prolonged use.
uplink-security-pulsecarbine-name = Pulse Carbine
uplink-security-pulsecarbine-desc = A high powered laser carbine normally reserved for elite TSFMC units. Has an internal low emission charging cell, for some degree of prolonged use.
...
uplink-security-speedloader-name = .357 magnum Speed Loader
uplink-security-speedloader-desc = A revolver speed loader that comes pre-loaded with .357 magnum cartridges.
uplink-security-speedloaderrubber-name = .357 magnum Rubber Speed Loader
...
uplink-security-empgrenade-box-name = EMP Grenade
uplink-security-empgrenade-box-desc = A handheld grenade that emits a high energy pulse that disrupts electronics and power systems in a moderately large radius.
uplink-security-explosivegrenade-box-name = Explosive Grenade
uplink-security-explosivegrenade-box-desc = A grenade that causes a large explosion, damaging infrastructure and personnel nearby.
uplink-security-incendiarygrenade-box-name = Incendiary Grenade
uplink-security-incendiarygrenade-box-desc = A grenade that releases a swarm of incendiary pellets.
uplink-security-shrapnelgrenade-box-name = Shrapnel Grenade
uplink-security-shrapnelgrenade-box-desc = A grenade that releases a large burst of lethal shrapnel.
uplink-security-smokegrenade-box-name = Smoke Grenade
uplink-security-smokegrenade-box-desc = A grenade that creates a large cloud of smoke, obscuring anything inside it and hiding it from thermal visors.
uplink-security-teargasgrenade-box-name = Tear Gas Grenade
uplink-security-teargasgrenade-box-desc = A grenade that creates a large cloud of tear gas, blinding anyone who inhales it.
uplink-security-flashbanggrenade-box-name = Flashbang Grenade
uplink-security-flashbanggrenade-box-desc = A grenade that creates a blinding flash.
uplink-security-stingergrenade-box-name = Stinger Grenade
uplink-security-stingergrenade-box-desc = A grenade that releases a large burst of painful rubber pellets, subduing anyone caught in the blast non-lethally.
uplink-security-breachingcharge-box-name = Breaching Charge
uplink-security-breachingcharge-box-desc = A plastic explosive that can be planted onto any surface in order to breach through it. Creates a loud buzzing noise when primed.
# Mono edit end
