...
shuttle-console-vertical-velocity = Heave Velocity:
...
shuttle-console-travel-state-targeting = Targetting ({$countdown})
shuttle-console-travel-state-stunned = [color=red]Respooling ({$countdown})[/color]
